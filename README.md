...
### 📚 멀티 플랫폼 웹툰 관리
- **네이버웹툰, 카카오페이지, 레진코믹스 지원**
- 플랫폼별 필터링 (탭 스와이프로 간편 전환)
- 플랫폼 배지로 한눈에 구분
...
### 📊 진행률 추적
- 각 웹툰별 마지막으로 읽은 회차를 로컬에 저장
- **이어보기 기능** - 마지막 읽은 회차로 바로 이동
- 상대적 시간 표시 (3일 전, 방금 전 등)
- Pull-to-refresh로 진행률 갱신

### ❤️ 즐겨찾기
- 자주 보는 웹툰을 즐겨찾기에 추가/제거
- My 화면에서 즐겨찾기 목록 관리
- 실시간 동기화

### 🔍 검색 및 필터
- 웹툰 제목으로 실시간 검색
- 플랫폼별 필터링 (전체/네이버/카카오/레진)
- 검색 결과 즉시 반영
